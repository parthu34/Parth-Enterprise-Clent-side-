...
<html>
	...
	<script src="js/modernizr.js"></script> <!-- Modernizr -->
        ...
        <title>Vollyball Detalils Page</title>
    </head>
    <body>
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from vl_product where id='"+id+"'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
			...
			<div class="container-fliud">
				<div class="wrapper row">
					...
					<div class="details col-md-6">
						<h3 class="product-title"><%= rs.getString("vl_product_name")%></h3>
						<div class="rating">
						</div>
                                                <p class="vote"><strong>Product ID:<%= rs.getInt("id")%></strong></p>
						<p class="product-description"><%= rs.getString("vl_product_desc")%></p>
						<h4 class="price">current price: <span>&#8377; <%= rs.getString("vl_product_price")%></span></h4>
						...
						<div class="action">
                                                    <a href="confirm_order.jsp?vl_id=<%= rs.getInt("id")%>"><button class="add-to-cart btn btn-default" type="button">Place Order</button></a>
