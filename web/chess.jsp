<%-- 
    Document   : chess
    Created on : 28 Dec, 2017, 11:17:17 PM
    Author     : parth
--%>
...
<head>
	...
	<link rel="stylesheet" href="css/style_chess.css"> <!-- Resource style -->
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" href="#0" data-type="all">CHESS</a></li>
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from che_product where che_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix  <%= rs.getString("che_product_brand")%> <%= rs.getString("che_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1" height="200"width="300">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("che_product_price")%></h2>
					<p class="des"><%= rs.getString("che_product_name")%></p></a>
                                    <a href="che_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<input type="search" placeholder="Try chess...">
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".SG" type="checkbox" id="checkbox1">
			    			<label class="checkbox-label" for="checkbox1">SG</label>
						</li>

						<li>
							<input class="filter" data-filter=".RUNNING" type="checkbox" id="checkbox2">
							<label class="checkbox-label" for="checkbox2">RUNNING</label>
						</li>

						<li>
							<input class="filter" data-filter=".RADHEY" type="checkbox" id="checkbox3">
							<label class="checkbox-label" for="checkbox3">RADHEY</label>
						</li>
						<li>
							<input class="filter" data-filter=".POOJA CREATION" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">POOJA CREATION</label>
						</li>

						<li>
							<input class="filter" data-filter=".KAUSHAL CREATION" type="checkbox" id="checkbox5">
							<label class="checkbox-label" for="checkbox5">KAUSHAL CREATION</label>
						</li>
