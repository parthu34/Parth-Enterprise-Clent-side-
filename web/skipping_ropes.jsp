<%-- 
    Document   : skipping_ropes
    Created on : 28 Dec, 2017, 11:18:17 PM
    Author     : parth
--%>
...
<head>
	...
	<link rel="stylesheet" href="css/style_sr.css"> <!-- Resource style -->
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" href="#0" data-type="all">SKIPPING PRODUCTS</a></li>
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from sr_product where sr_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix  <%= rs.getString("sr_product_brand")%> <%= rs.getString("sr_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1"height="200"width="300">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("sr_product_price")%></h2>
					<p class="des"><%= rs.getString("sr_product_name")%></p></a>
                                    <a href="sr_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".PORT" type="checkbox" id="checkbox1">
			    			<label class="checkbox-label" for="checkbox1">PORT</label>
						</li>

						<li>
							<input class="filter" data-filter=".COMEX" type="checkbox" id="checkbox2">
							<label class="checkbox-label" for="checkbox2">COMEX</label>
						</li>

						<li>
							<input class="filter" data-filter=".PSE" type="checkbox" id="checkbox3">
							<label class="checkbox-label" for="checkbox3">PSE</label>
						</li>
						<li>
							<input class="filter" data-filter=".TRIUMPH" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">TRIUMPH</label>
						</li>
