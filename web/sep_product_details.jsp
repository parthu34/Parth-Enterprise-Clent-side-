<%-- 
    Document   : ss_product_details.jsp
    Created on : 29 Dec, 2017, 12:37:44 PM
    Author     : parth
--%>

<%-- 
    Document   : car_product_details
    Created on : 29 Dec, 2017, 12:35:53 PM
    Author     : parth
--%>
...
<html>
	...
	<script src="js/modernizr.js"></script> <!-- Modernizr -->
        ...
        <title>Strategy Equipments Products Details Page</title>
    </head>
    <body>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
                                                    <div class="tab-pane active"><img src="img/gallery/<%= data1%>" alt="Image 1" width="400" height="450"></div>
					...
					<div class="details col-md-6">
						<h3 class="product-title"><%= rs.getString("sep_product_name")%></h3>
						<div class="rating">
						</div>
                                                <p class="vote"><strong>Product ID:<%= rs.getInt("id")%></strong></p>
						<p class="product-description"><%= rs.getString("sep_product_desc")%></p>
						<h4 class="price">current price: <span>&#8377; <%= rs.getString("sep_product_price")%></span></h4>
						...
						<div class="action">
                                                    <a href="confirm_order.jsp?sep_id=<%= rs.getInt("id")%>"><button class="add-to-cart btn btn-default" type="button">Place Order</button></a>
