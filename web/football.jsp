...
<head>
	...
	<link rel="stylesheet" href="css/style_ft.css"> <!-- Resource style -->
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" href="#0" data-type="all">FOOTBALLS</a></li>
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from ft_product where ft_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix  <%= rs.getString("ft_product_brand")%> <%= rs.getString("ft_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("ft_product_price")%></h2>
					<p class="des"><%= rs.getString("ft_product_name")%></p></a>
                                    <a href="ft_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<input type="search" placeholder="Try football...">
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						...
						<li>
							<input class="filter" data-filter=".NIKE" type="checkbox" id="checkbox2">
							<label class="checkbox-label" for="checkbox2">NIKE</label>
						</li>
						...
						<li>
							<input class="filter" data-filter=".PUMA" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">PUMA</label>
						</li>

						<li>
							<input class="filter" data-filter=".SLAZENGER" type="checkbox" id="checkbox5">
							<label class="checkbox-label" for="checkbox5">SLAZENGER</label>
						</li>
