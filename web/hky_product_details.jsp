<%-- 
    Document   : hky_product_details
    Created on : 26 Dec, 2017, 9:53:53 PM
    Author     : parth
--%>
...
<html>
	...
	<script src="js/modernizr.js"></script> <!-- Modernizr -->
        ...
        <title>Hockey Detalils Page</title>
    </head>
    <body>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
                                                    <div class="tab-pane active"><img src="img/gallery/<%= data1%>" alt="Image 1" height="550" width="350"></div>
					...
					<div class="details col-md-6">
						<h3 class="product-title"><%= rs.getString("hky_product_name")%></h3>
						<div class="rating">
						</div>
                                                <p class="vote"><strong>Product ID:<%= rs.getInt("id")%></strong></p>
						<p class="product-description"><%= rs.getString("hky_product_desc")%></p>
						<h4 class="price">current price: <span>&#8377; <%= rs.getString("hky_product_price")%></span></h4>
						...
						<div class="action">
                                                    <a href="confirm_order.jsp?hky_id=<%= rs.getInt("id")%>"><button class="add-to-cart btn btn-default" type="button">Place Order</button></a>
