<%-- 
    Document   : carrom
    Created on : 28 Dec, 2017, 11:16:42 PM
    Author     : parth
--%>
...
<head>
	...
	<link rel="stylesheet" href="css/style_car.css"> <!-- Resource style -->
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" href="#0" data-type="all">CARROM</a></li>
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from car_product where car_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix  <%= rs.getString("car_product_brand")%> <%= rs.getString("car_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1"height="300"width="300">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("car_product_price")%></h2>
					<p class="des"><%= rs.getString("car_product_name")%></p></a>
                                    <a href="car_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<input type="search" placeholder="Try carrom...">
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".TURBO" type="checkbox" id="checkbox1">
			    			<label class="checkbox-label" for="checkbox1">TURBO</label>
						</li>

						<li>
							<input class="filter" data-filter=".OSEL" type="checkbox" id="checkbox2">
							<label class="checkbox-label" for="checkbox2">OSEL</label>
						</li>

						<li>
							<input class="filter" data-filter=".SST" type="checkbox" id="checkbox3">
							<label class="checkbox-label" for="checkbox3">SST</label>
						</li>
						<li>
							<input class="filter" data-filter=".PRECISE" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">PRECISE</label>
						</li>

						<li>
							<input class="filter" data-filter=".SRC" type="checkbox" id="checkbox5">
							<label class="checkbox-label" for="checkbox5">SRC</label>
						</li>
