...
<html>
	...
	<script src="js/modernizr.js"></script> <!-- Modernizr -->
        ...
        <title>Carrom Detalils Page</title>
    </head>
    <body>
				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
                                                    <div class="tab-pane active"><img src="img/gallery/<%= data1%>" alt="Image 1" height="500" width="450"></div>
					...
					<div class="details col-md-6">
						<h3 class="product-title"><%= rs.getString("car_product_name")%></h3>
						<div class="rating">
						</div>
                                                <p class="vote"><strong>Product ID:<%= rs.getInt("id")%></strong></p>
						<p class="product-description"><%= rs.getString("car_product_desc")%></p>
						<h4 class="price">current price: <span>&#8377; <%= rs.getString("car_product_price")%></span></h4>
						...
						<div class="action">
                                                    <a href="confirm_order.jsp?car_id=<%= rs.getInt("id")%>"><button class="add-to-cart btn btn-default" type="button">Place Order</button></a>
