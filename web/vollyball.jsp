...
<head>
	...
	<link rel="stylesheet" href="css/style_volly.css"> <!-- Resource style -->
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter" data-filter=".leather"><a href="#" data-type="leather">Leather Material Vollyballs</a></li>
					<li class="filter" data-filter=".pu"><a href="#" data-type="pu">PU Material Vollyball</a></li>
				</ul> <!-- cd-filters -->
			</div> <!-- cd-tab-filter -->
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from vl_product where vl_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix <%= rs.getString("vl_product_type")%> <%= rs.getString("vl_product_brand")%> <%= rs.getString("vl_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("vl_product_price")%></h2>
					<p class="des"><%= rs.getString("vl_product_name")%></p></a>
                                    <a href="vl_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<input type="search" placeholder="Try Vollyball...">
					</div> <!-- cd-filter-content -->
				</div> <!-- cd-filter-block -->

				<div class="cd-filter-block">
					<h4>Vollyball Material</h4>
					...
					<ul class="cd-filter-content cd-filters list">
						...
						<li>
							<input class="filter" data-filter=".leather" type="radio" name="radioButton" id="prod_radio2">
							<label class="radio-label" for="prod_radio2">Leather Material</label>
						</li>

						<li>
							<input class="filter" data-filter=".pu" type="radio" name="radioButton" id="prod_radio3">
							<label class="radio-label" for="prod_radio3">PU Material</label>
						</li>
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						...
						<li>
							<input class="filter" data-filter=".PUMA" type="checkbox" id="checkbox2">
							<label class="checkbox-label" for="checkbox2">PUMA</label>
						</li>

						<li>
							<input class="filter" data-filter=".COSCO" type="checkbox" id="checkbox3">
							<label class="checkbox-label" for="checkbox3">COSCO</label>
						</li>
						<li>
							<input class="filter" data-filter=".ADIDAS" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">ADIDAS</label>
						</li>
