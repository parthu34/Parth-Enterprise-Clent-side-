<%-- 
    Document   : hockey
    Created on : 26 Dec, 2017, 9:42:28 PM
    Author     : parth
--%>
...
<head>
	...
	<link rel="stylesheet" href="css/style_hk.css"> <!-- Resource style -->
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" href="#0" data-type="all">HOCKEY</a></li>
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from hky_product where hky_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix  <%= rs.getString("hky_product_brand")%> <%= rs.getString("hky_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1"height="200"width="300">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("hky_product_price")%></h2>
					<p class="des"><%= rs.getString("hky_product_name")%></p></a>
                                    <a href="hky_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<input type="search" placeholder="Try hockey...">
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".MAYOR" type="checkbox" id="checkbox1">
			    			<label class="checkbox-label" for="checkbox1">MAYOR</label>
						</li>

						<li>
							<input class="filter" data-filter=".ALFA" type="checkbox" id="checkbox2">
							<label class="checkbox-label" for="checkbox2">ALFA</label>
						</li>

						<li>
							<input class="filter" data-filter=".BAS" type="checkbox" id="checkbox3">
							<label class="checkbox-label" for="checkbox3">BAS</label>
						</li>
						<li>
							<input class="filter" data-filter=".SACHINE" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">SACHINE</label>
						</li>

						<li>
							<input class="filter" data-filter=".GADE" type="checkbox" id="checkbox5">
							<label class="checkbox-label" for="checkbox5">GADE</label>
						</li>
