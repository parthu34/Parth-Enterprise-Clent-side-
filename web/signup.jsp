  ...
  <div ng-controller="DemoCtrl" ng-cloak="" class="md-inline-form" ng-app="MyApp" layout="column" layout-sm="row" layout-align="center center" layout-align-sm="start start" layout-fill>
		<md-content id="SignupContent" class="md-whiteframe-10dp" flex-sm>
				<md-toolbar flex id="materialToolbar">
						<div class="md-toolbar-tools"> <span flex=""></span> <span class="md-headline" align="center">Sign Up For Parth Enterprise</span> <span flex=""></span> </div>
				</md-toolbar>
				<div layout-padding="">
						<div></div>
						<form name="userForm" method="POST" action="controller/signup_c.jsp" ng-submit="user.submit(userForm.$valid)">
								...
								<div layout="row" layout-sm="column">
										...
										<md-input-container flex-gt-sm="60">
												...
												<input name="user_name" required type="text" ng-pattern="/^[a-zA-Z'. -]+$/" placeholder="Your User Name">
								...
								<md-button class="md-raised md-primary" ng-href="login.jsp" target="_blank" style="width:100%; margin: 15px 0px 0px 0px;">Already Registered</md-button>
						</form>
				</div>
		</md-content>
</div>
