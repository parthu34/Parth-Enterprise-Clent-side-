...
<head>
	...
	<link rel="stylesheet" href="css/style_bad.css"> <!-- Resource style -->
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" href="#0" data-type="all">BADMINTON</a></li>
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from bdm_product where bdm_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix  <%= rs.getString("bdm_product_brand")%> <%= rs.getString("bdm_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1" height="450" width="250">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("bdm_product_price")%></h2>
					<p class="des"><%= rs.getString("bdm_product_name")%></p></a>
                                    <a href="bdm_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<input type="search" placeholder="Try badminton...">
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".YONEX" type="checkbox" id="checkbox1">
			    			<label class="checkbox-label" for="checkbox1">YONEX</label>
						</li>

						<li>
							<input class="filter" data-filter=".LI_NING" type="checkbox" id="checkbox2">
							<label class="checkbox-label" for="checkbox2">LI NING</label>
						</li>

						<li>
							<input class="filter" data-filter=".ADIDAS" type="checkbox" id="checkbox3">
							<label class="checkbox-label" for="checkbox3">ADIDAS</label>
						</li>
						<li>
							<input class="filter" data-filter=".WILSON" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">WILSON</label>
						</li>
