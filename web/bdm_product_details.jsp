<%-- 
    Document   : bdm_product_details
    Created on : 29 Dec, 2017, 12:29:42 PM
    Author     : parth
--%>
...
<html>
	...
	<script src="js/modernizr.js"></script> <!-- Modernizr -->
        ...
        <title>BADMINTON Details Page</title>
    </head>
    <body>
			...
			<div class="container-fliud">
				<div class="wrapper row">
					...
					<div class="details col-md-6">
						<h3 class="product-title"><%= rs.getString("bdm_product_name")%></h3>
						<div class="rating">
						</div>
                                                <p class="vote"><strong>Product ID:<%= rs.getInt("id")%></strong></p>
						<p class="product-description"><%= rs.getString("bdm_product_desc")%></p>
						<h4 class="price">current price: <span>&#8377; <%= rs.getString("bdm_product_price")%></span></h4>
						...
						<div class="action">
                                                    <a href="confirm_order.jsp?bdm_id=<%= rs.getInt("id")%>"><button class="add-to-cart btn btn-default" type="button">Place Order</button></a>
