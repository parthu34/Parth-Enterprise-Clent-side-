...
<html>
<head>
	<title>Cricket Equipments</title>
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter" data-filter=".Cricket_Bats"><a href="#" data-type="cricket_bats">cricket bats</a></li>
					<li class="filter" data-filter=".Tennis_Cricket_Ball"><a href="#" data-type="tennis_ball">Tennis Ball</a></li>
				</ul> <!-- cd-filters -->
			</div> <!-- cd-tab-filter -->
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from ck_product where ck_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix <%= rs.getString("ck_product_type")%> <%= rs.getString("ck_product_brand")%> <%= rs.getString("ck_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("ck_product_price")%></h2>
					<p class="des"><%= rs.getString("ck_product_name")%></p></a>
                                    <a href="ck_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				<div class="cd-filter-block">
					...
					<div class="cd-filter-content">
						<input type="search" placeholder="Try Cricket_Bats...">
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						...
						<li>
							<input class="filter" data-filter=".Cricket_Bats" type="radio" name="radioButton" id="prod_radio2">
							<label class="radio-label" for="prod_radio2">Cricket Bats</label>
						</li>

						<li>
							<input class="filter" data-filter=".Tennis_Cricket_Ball" type="radio" name="radioButton" id="prod_radio3">
							<label class="radio-label" for="prod_radio3">Tennis Ball</label>
						</li>
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".MRF" type="checkbox" id="checkbox1">
			    			<label class="checkbox-label" for="checkbox1">MRF</label>
						</li>

						<li>
							<input class="filter" data-filter=".TON" type="checkbox" id="checkbox2">
							<label class="checkbox-label" for="checkbox2">TON</label>
						</li>

						<li>
							<input class="filter" data-filter=".SG" type="checkbox" id="checkbox3">
							<label class="checkbox-label" for="checkbox3">SG</label>
						</li>
						<li>
							<input class="filter" data-filter=".NIVIA" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">NIVIA</label>
						</li>

						<li>
							<input class="filter" data-filter=".GM" type="checkbox" id="checkbox5">
							<label class="checkbox-label" for="checkbox5">GM</label>
						</li>

						<li>
							<input class="filter" data-filter=".GURU" type="checkbox" id="checkbox6">
							<label class="checkbox-label" for="checkbox6">GURU</label>
						</li>
                                                
                                                <li>
							<input class="filter" data-filter=".PUMA" type="checkbox" id="checkbox7">
							<label class="checkbox-label" for="checkbox7">PUMA</label>
						</li>
                                                <li>
							<input class="filter" data-filter=".MARK" type="checkbox" id="checkbox8">
							<label class="checkbox-label" for="checkbox8">MARK</label>
						</li>
