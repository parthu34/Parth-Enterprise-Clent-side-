<%-- 
    Document   : sports_shoes
    Created on : 28 Dec, 2017, 11:18:51 PM
    Author     : parth
--%>
...
<head>
	...
	<link rel="stylesheet" href="css/style_ss.css"> <!-- Resource style -->
		...
		<div class="cd-tab-filter-wrapper">
			<div class="cd-tab-filter">
				<ul class="cd-filters">
					...
					<li class="filter"><a class="selected" href="#0" data-type="all">SPORTS SHOES</a></li>
...
<%                                                        
                                                          ...
                                                          try
                                                          {
                                                            ...
                                                            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/parth_enterprise?zeroDateTimeBehavior=convertToNull","root","");
                                                            Statement stm = con.createStatement();
                                                            String query="select *from ss_product where ss_product_status='In Stock'";
                                                            ResultSet rs=stm.executeQuery(query);
                                                            while(rs.next())
                                                            {
                                                      %>
                                                                    <%
                                                                        String data=rs.getString("File_Path");
                                                                           ...
                                                                           //out.println(data1);
                                                                            %>
                                                                            <li class="mix  <%= rs.getString("ss_product_brand")%> <%= rs.getString("ss_product_price_range")%>"><img src="img/gallery/<%= data1%>" alt="Image 1" height="300" width="200">
                                    <section class="p_data">
					<h2 class="price">&#8377; <%= rs.getString("ss_product_price")%></h2>
					<p class="des"><%= rs.getString("ss_product_name")%></p></a>
                                    <a href="ss_product_details.jsp?id=<%= rs.getInt("id")%>"><button class="btn">See Details</button></a>
					</section>
                                </li>
                                                                            <%	 }
                                                        con.close();
			...
			<form>
				...
				<div class="cd-filter-block">
					...
					<ul class="cd-filter-content cd-filters list">
						<li>
							<input class="filter" data-filter=".ADIDAS" type="checkbox" id="checkbox1">
			    			<label class="checkbox-label" for="checkbox1">ADIDAS</label>
						</li>
						...
						<li>
							<input class="filter" data-filter=".LOTTO" type="checkbox" id="checkbox4">
							<label class="checkbox-label" for="checkbox4">LOTTO</label>
						</li>

						<li>
							<input class="filter" data-filter=".NIKE" type="checkbox" id="checkbox5">
							<label class="checkbox-label" for="checkbox5">NIKE</label>
						</li>
